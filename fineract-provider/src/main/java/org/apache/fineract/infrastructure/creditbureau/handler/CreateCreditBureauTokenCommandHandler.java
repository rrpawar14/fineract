...
import org.apache.fineract.infrastructure.creditbureau.service.CreditBureauTokenWritePlatformService;
...
public class CreateCreditBureauTokenCommandHandler implements NewCommandSourceHandler {
    ...
    private final CreditBureauTokenWritePlatformService writePlatformService;

    @Autowired
    public CreateCreditBureauTokenCommandHandler(final CreditBureauTokenWritePlatformService writePlatformService) {
