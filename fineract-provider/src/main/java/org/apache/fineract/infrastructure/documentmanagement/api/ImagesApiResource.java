...
public class ImagesApiResource {
    ...
    public enum EntityTypeForImages {
        ...
        STAFF, CLIENTS, NEWVEHICLE, INVOICEIMAGE, USEDVEHICLE, VEHICLEDETAILS, GUARANTOR, BANK, PROFILEIMAGE, CUSTOMERIMAGE, ADHARPHOTO, GOVERNMENTDOCUMENT, ENGINE, CHASSIS, VEHICLE, GUARANTORIMAGE, GUARANTORDOCUMENT, FEENROLL, FENEWLOAN;
