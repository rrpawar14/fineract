...
public class ImagesApiResource {
    ...
    public enum EntityTypeForImages {
        ...
        STAFF, CLIENTS, NEWVEHICLE, INVOICEIMAGE, CUSTOMERIMAGE, ADHARPHOTO, PANCARD, VEHICLE_LICENCE, GUARANTORIMAGE, G_ADHARPHOTO, G_PANCARD, G_VEHICLE_LICENCE, ENGINE, CHASSIS, VEHICLEINSURANCE, KMREADING, RCBOOK, VEHICLE, GUARANTOR, BANK, PROFILEIMAGE, FEENROLL, FENEWLOAN, EMPLOYEE_ADHAR, EMPLOYEE_PANCARD;
