...
public class ImagesApiResource {
    ...
    public enum EntityTypeForImages {
        ...
        STAFF, CLIENTS, NEWVEHICLE, INVOICEIMAGE, CUSTOMERIMAGE, ADHARPHOTO, PANCARD, VEHICLE_LICENCE, FRONT_ADHARCARD, BACK_ADHARCARD, FRONT_PANCARD, BACK_PANCARD, FRONT_VEHICLE_LICENCE, BACK_VEHICLE_LICENCE, GUARANTORIMAGE, G_ADHARPHOTO, G_PANCARD, G_VEHICLE_LICENCE, G_FRONT_ADHARCARD, G_BACK_ADHARCARD, G_FRONT_PANCARD, G_BACK_PANCARD, G_FRONT_VEHICLE_LICENCE, G_BACK_VEHICLE_LICENCE, ENGINE, CHASSIS, VEHICLEINSURANCE, KMREADING, RCBOOK, VEHICLE_FRONT, VEHICLE_LEFT, VEHICLE_RIGHT, VEHICLE_BACK, VEHICLE_CHALAN_REPORT, VEHICLE_TRANSACTION_HISTORY, GUARANTOR, BANK, PROFILEIMAGE, ENROLL_CUSTOMERIMAGE, ENROLL_ADHARPHOTO, ENROLL_PANCARD, ENROLL_VEHICLE_LICENCE, ENROLL_FRONT_ADHARCARD, ENROLL_BACK_ADHARCARD, ENROLL_FRONT_PANCARD, ENROLL_BACK_PANCARD, ENROLL_FRONT_VEHICLE_LICENCE, ENROLL_BACK_VEHICLE_LICENCE, FENEWLOAN, EMPLOYEE_ADHAR, EMPLOYEE_PANCARD, EMPLOYEE_VEHICLE_LICENCE;
