...
public class ImagesApiResource {
    ...
    public enum EntityTypeForImages {
        ...
        STAFF, CLIENTS, NEWVEHICLE, INVOICEIMAGE, CUSTOMERIMAGE, ADHARPHOTO, GOVERNMENTDOCUMENT, ENGINE, CHASSIS, VEHICLE, VEHICLEDETAILS_RCBOOK, GUARANTOR, GUARANTORIMAGE, GUARANTORDOCUMENT, BANK, PROFILEIMAGE, FEENROLL, FENEWLOAN;
