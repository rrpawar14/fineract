...
@Service
@CommandType(entity = "USEDVEHICLELOAN", action = "CREATE")

public class UsedVehicleLoanCommandHandler implements NewCommandSourceHandler {

    private final VehicleLoanManagementWritePlatformService writePlatformService;

    @Autowired
    public UsedVehicleLoanCommandHandler(final VehicleLoanManagementWritePlatformService writePlatformService) {
