...
@Service
@CommandType(entity = "NEWVEHICLELOAN", action = "CREATE")
public class NewVehicleLoanCommandHandler implements NewCommandSourceHandler {

    private final VehicleLoanManagementWritePlatformService writePlatformService;

    @Autowired
    public NewVehicleLoanCommandHandler(final VehicleLoanManagementWritePlatformService writePlatformService) {
