...
public class UsedVehicleLoan extends AbstractPersistableCustom {
     ...
     *
     * @JoinColumn(name = "address_id", nullable = true) private Address address;
     */
    ...
    public static UsedVehicleLoan fromJson(final JsonCommand command, final CustomerDetails customerDetails,
        ...
        return new UsedVehicleLoan(customerName, vehicleType, loanType, customerDetails, vehicleDetails, customerGuarantor, bankDetails);
