 ...
 * under the License.
 */
package org.apache.fineract.vlms.loantransfer.domain;
...
@Entity
@Table(name = "m_loantransfer_task")
public class LoanTransferTask extends AbstractPersistableCustom {
    ...
    public static LoanTransferTask fromJson(final JsonCommand command) {
