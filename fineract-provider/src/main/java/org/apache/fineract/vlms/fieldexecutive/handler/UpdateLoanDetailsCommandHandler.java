...
@Service
@CommandType(entity = "LOANDETAIL", action = "UPDATE")
public class UpdateLoanDetailsCommandHandler implements NewCommandSourceHandler {

    private final VehicleLoanManagementWritePlatformService vehicleLoanManagementWritePlatformService;

    @Autowired
    public UpdateLoanDetailsCommandHandler(final VehicleLoanManagementWritePlatformService vehicleLoanManagementWritePlatformService) {
