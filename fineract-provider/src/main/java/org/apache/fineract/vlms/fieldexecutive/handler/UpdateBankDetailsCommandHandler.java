...
@Service
@CommandType(entity = "BANKDETAIL", action = "UPDATE")
public class UpdateBankDetailsCommandHandler implements NewCommandSourceHandler {

    private final VehicleLoanManagementWritePlatformService vehicleLoanManagementWritePlatformService;

    @Autowired
    public UpdateBankDetailsCommandHandler(final VehicleLoanManagementWritePlatformService vehicleLoanManagementWritePlatformService) {
