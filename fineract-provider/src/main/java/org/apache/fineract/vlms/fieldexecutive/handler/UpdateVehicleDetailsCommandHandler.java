...
@Service
@CommandType(entity = "VECHILEDETAIL", action = "UPDATE")
public class UpdateVehicleDetailsCommandHandler implements NewCommandSourceHandler {

    private final VehicleLoanManagementWritePlatformService vehicleLoanManagementWritePlatformService;

    @Autowired
    public UpdateVehicleDetailsCommandHandler(final VehicleLoanManagementWritePlatformService vehicleLoanManagementWritePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        return this.vehicleLoanManagementWritePlatformService.updateVehicleDetails(command.entityId(), command);
    }
}
