...
@Service
@CommandType(entity = "CUSTOMERDETAIL", action = "UPDATE")
public class UpdateCustomerDetailsCommandHandler implements NewCommandSourceHandler {
    ...
    @Autowired
    public UpdateCustomerDetailsCommandHandler(final VehicleLoanManagementWritePlatformService vehicleLoanManagementWritePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        return this.vehicleLoanManagementWritePlatformService.updateCustomerDetails(command.entityId(), command);
    }
}
