...
@Entity
@Table(name = "m_fe_vehicle_details")
public class FEVehicleDetails extends AbstractPersistableCustom {
    ...
    public static FEVehicleDetails fromJson(final JsonCommand command) {
        ...
        return new FEVehicleDetails(vehicleNumber, maker, model, color, mfgYear, engineNumber, chassisNumber, insuranceCompany,
                insurancePolicy, insuranceExpiry, kmReading);
