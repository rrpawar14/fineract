...
public class CashierModuleTask extends AbstractPersistableCustom {
    ...
    @Column(name = "assign_by", nullable = false, length = 100)
    ...
    public Map<String, Object> update(final JsonCommand command) {
        ...
        final String assignByParamName = "assignBy";
        if (command.isChangeInStringParameterNamed(assignByParamName, this.assignBy)) {
            final String newValue = command.stringValueOfParameterNamed(assignByParamName);
            actualChanges.put(assignByParamName, newValue);
            this.assignBy = StringUtils.defaultIfEmpty(newValue, null);
        }
